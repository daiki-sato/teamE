...
<head>
  ...
  <title>applicationForm_compare</title>
  <link rel="stylesheet" href="../css/reset.css">
  <link rel="stylesheet" href="../css/applicationForm_compare.css">
</head>
<body>

      <div class="applicationForm-compare__title">
          <h4 class="applicationForm-compare__text">よく比較・検討されているエージェント</h4>
          <h5 class="applicationForm-compare__text2">内定者は平均5エージェントから話を聞いています！</h5>
      </div>
  
      <div class="applicationForm-compare__contents">
