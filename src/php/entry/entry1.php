...
$familyname = isset($_SESSION['familyname']) ? $_SESSION['familyname'] : NULL;
$firstname = isset($_SESSION['firstname']) ? $_SESSION['firstname'] : NULL;
$familyfurigana = isset($_SESSION['familyfurigana']) ? $_SESSION['familyfurigana'] : NULL;
$firstfurigana = isset($_SESSION['firstfurigana']) ? $_SESSION['firstfurigana'] : NULL;
      ...
      <div class="entry-area">
        <form id="main_contact" method="post" action="entry2.php">
          ...
          <div class="form-group">
            ...
            <div class="inputarea">
              <span class="error"><?php echo h($error_year); ?></span>
              ...
              <label for="month">
                <span class="error"><?php echo h($error_month); ?></span>
              </label>
              ...
              <label for="day">
                <span class="error"><?php echo h($error_day); ?></span>
              </label>
          ...
          <div class="form-group">
            ...
            <span class="error"><?php echo h($error_sex); ?></span>
            <div class="inputarea">
          ...
          <div class="form-group">
            ...
            <span class="error"><?php echo h($error_prefecture); ?></span>
            <div class="inputarea">
